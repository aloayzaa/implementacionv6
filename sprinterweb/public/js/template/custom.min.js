function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function (b) {
        ...
        c.is(".active") ? (c.removeClass("active active-sm"), $("ul:first", c).slideUp(function () {
            ...
            $SIDEBAR_MENU.find("li ul").slideUp()) : ($SIDEBAR_MENU.find("li").removeClass("active active-sm"), $SIDEBAR_MENU.find("li ul").slideUp()), c.addClass("active"), $("ul:first", c).slideDown(function () {
            a()
        }))
...
function init_charts() {
    if ("undefined" != typeof Chart) {
        if (Chart.defaults.global.legend = {enabled: !1}, $("#canvas_line").length) {
