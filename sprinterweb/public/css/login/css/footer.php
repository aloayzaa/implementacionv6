    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 hidden-xs">
                <p><font color="white">Copyright © 2016 - 2017</font> <a href="index.php" style="text-decoration: none">Anikama Group S.A.C.</a> <font color="white">All Rights Reserved</font></p>
            </div>
            
            <!--------- Mov footer start ---------->
            <div class="col-md-5 hidden-lg hidden-md hidden-sm">
                <p><font color="white" size="1px">Copyright © 2016 - 2017</font> 
                    <a href="index.php"><font color="#428bca" size="1px">ANIKAMA GROUP S.A.C.</font></a> <font color="white" size="1px">All Rights Reserved</font>
                </p>
            </div>
            <!---------- Mov footer end ----------->
