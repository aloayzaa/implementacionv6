    ...
    <div class="x_panel">
        <div class="x_content">
            <form class="form-horizontal" id="frm_generales" name="frm_generales" method="POST">
                <input type="hidden" id="ruta" name="ruta" value="{{ route('store.typeheading') }}">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12">
                                <input type="text" id="txt_codigo_rubro" name="txt_codigo_rubro" class="form-control" value="{{ $codigo }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-sm-1 col-xs-12 label-input">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <input type="text" name="txt_descripcion_rubro" id="txt_descripcion_rubro" class="form-control">
                            </div>
                        </div>
                        <div class="row">
