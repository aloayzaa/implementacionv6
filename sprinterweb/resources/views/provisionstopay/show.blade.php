                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="col-md-12 col-xs-12">
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="form-group col-md-2" style="width: 100px">
                                        ...
                                        <input type="text" class="form-control text-center" name="txt_numero" id="txt_numero" placeholder="0000" value="{{ $docxpagar->numero }}" readonly>
                                    </div>
                                     <div class="form-group col-md-2" style="width: 165px">
                                         <label for="txt_fecha">Fecha: </label>
                                         <input type="date" class="form-control"  name="txt_fecha" id="txt_fecha" min="{{ $period->inicio }}" max="{{ $period->final }}" value="{{ $docxpagar->fechaproceso }}"> {{--fechadoc para que no interfiera con la fecha de abajo--}}
                                     </div>
                                    <div class="form-group col-md-2">
                                        <label for="txt_ordencompra">Orden Compra: </label>
                                        <div class="input-group input-group-sm" style="z-index: 0">
                                            <input type="text" class="form-control" name="txt_ordencompra" ondblclick="add_orden({{ 0 }})" id="txt_ordencompra" value="{{ $codigo_orden }}" readonly>
                                        ...
                                        <input type="hidden" class="form-control" name="txt_ordencompra_id" id="txt_ordencompra_id" value="{{ $ordencompra_id }}" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control select2" name="txt_tipocompra" id="txt_tipocompra">
                                            @foreach($tipocompras as $tipocompra)
                                                <option value="{{ $tipocompra->id }}"
                                                  @if($tipocompra->id == $docxpagar->tipoCompra['id']) selected @endif>
                                                    {{ $tipocompra->codigo }} | {{ $tipocompra->descripcion }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                               ...
                               <div class="row">
                                   <div class="form-row">
                                       <div class="form-group col-md-4">
                                           ...
                                           <select class="form-control select2" name="txt_tercero" id="txt_tercero">
                                               <option value="{{$docxpagar->tercero_id}}" selected>{{$docxpagar->tercero->codigo}} | {{$docxpagar->tercero->descripcion}}</option>
                                           </select>
                                       </div>
                                       <div class="form-group col-md-2">
                                       ...
                                       <div class="form-group col-md-1">
                                           ...
                                           <input type="text" class="form-control" name="txt_seriedoc" id="txt_seriedoc" placeholder="0000" value="{{ $docxpagar->seriedoc }}">
                                       </div>
                                       <div class="form-group col-md-1">
                                           <label for="txt_numerodoc">Número: </label>
                                           <input type="text" class="form-control" name="txt_numerodoc" id="txt_numerodoc" placeholder="0000" value="{{ $docxpagar->numerodoc }}">
                                       </div>
                                       <div class="form-group col-md-2">
                                           <label for="txt_fechadoc">Fecha: </label>
                                           <input type="date" class="form-control" name="txt_fechadoc" id="txt_fechadoc" value="{{ $docxpagar->fechadoc }}">
                                       </div>
                                       <div class="form-group col-md-2">
                                           <label for="txt_tcambio">T. Cambio: </label>
                                           <input type="text" class="form-control typechange" name="txt_tcambio" id="txt_tcambio" value="{{ $docxpagar->tcambio }}" readonly>
                                       </div>
                                   </div>
                               </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control select2" name="txt_condicionpago" id="txt_condicionpago">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="date" class="form-control" name="txt_vencimiento" id="txt_vencimiento" value="{{ $docxpagar->vencimiento }}" readonly>
                                    </div>
                                    <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-1">
                                        ...
                                        <input type="text" class="form-control" name="txt_tc" id="txt_tc" value="{{ $docxpagar->tc }}" readonly>
                                    </div>
                                    <div class="form-group col-md-5">
                                        <label for="txt_glosa">Glosa: </label>
                                        <input type="text" class="form-control" name="txt_glosa" id="txt_glosa" value="{{ $docxpagar->glosa }}">
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="txt_clasificacion">Clasificación de Bien o Servicio: </label>
                                        <select class="form-control select2" name="txt_clasificacion" id="txt_clasificacion">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control select2" name="txt_adquisicion" id="txt_adquisicion">
                                            <option value="1" @if($docxpagar->tipoadq==1) selected @endif>1. Destino Gravado
                                            </option>
                                            <option value="2" @if($docxpagar->tipoadq==2) selected @endif>2. Destino Mixto
                                            </option>
                                            <option value="3" @if($docxpagar->tipoadq==3) selected @endif>3. Destino No Gravado
                                            </option>
                                            <option value="4" @if($docxpagar->tipoadq==4) selected @endif>4. No Gravadas
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group col-md-2">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control select2" name="txt_percepcion_id" id="txt_percepcion_id">
                                            <option value="" selected>-- Seleccione una opción --</option>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-1">
                                        ...
                                        <input type="text" class="form-control numero twodecimal" name="txt_base" id="txt_base" value="{{ $docxpagar->base }}">
                                    </div>
                                    <div class="form-group col-md-1">
                                        <label for="txt_inafecto">Inafecto: </label>
                                        <input type="text" class="form-control numero twodecimal" name="txt_inafecto" id="txt_inafecto" value="{{ $docxpagar->inafecto }}">
                                    </div>
                                    <div class="form-group col-md-1">
                                        <label for="txt_igv">IGV: </label>
                                        <input type="text" class="form-control desbloqueable numero twodecimal" name="txt_igv" id="txt_igv" value="{{ $docxpagar->impuesto }}" readonly>
                                    </div>
                                    <div class="form-group col-md-1" style="margin-top:-20px">
                                        @if($docxpagar->conpercepcion == 1)
                                            <input type="checkbox" id="check_impuesto" checked name="check_impuesto">Incluye</input>
                                        @else
                                            <input type="checkbox" id="check_impuesto" name="check_impuesto">Incluye</input>
                                        @endif
                                            <label for="txt_percepcion">Percepción: </label>
                                        <input type="text" class="form-control desbloqueable numero twodecimal" name="txt_percepcion" id="txt_percepcion" value="{{ $docxpagar->impuesto2 }}" readonly>
                                    </div>
                                    <div class="form-group col-md-1">
                                        <label for="txt_renta">Renta: </label>
                                        <input type="text" class="form-control desbloqueable numero twodecimal" name="txt_renta" id="txt_renta" value="{{ $docxpagar->impuesto3 }}" readonly>
                                    </div>
                                    <div class="form-group col-md-1">
                                        <label for="txt_total">Total: </label>
                                        <input type="text" class="form-control" name="txt_total" id="txt_total" value="{{ $docxpagar->total }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        <li role="presentation" class="active">
                                            <a href="#tab_content1" id="home-tab" class="tab" role="tab" data-toggle="tab" aria-expanded="true">Detalle del Documento</a>
                                        </li>
                                        <li role="presentation" class="">
                                            <a href="#tab_content2" role="tab" id="aplica-tab" class="tab" data-toggle="tab" aria-expanded="false">Datos Adicionales</a>
                                        </li>
                                        <li role="presentation" class="">
                                            <a href="#tab_content3" role="tab" id="aplica-tab" class="tab" data-toggle="tab" aria-expanded="false">Historial</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            @include ('provisionstopay.modals.add_cuenta')
...
@section('scripts')
  ...
  <script>
      $(document).ready(function () {
          ...
          $('#frm_generales *').not(".tab").prop('disabled',true);
      });
      backButtonRefresh();
