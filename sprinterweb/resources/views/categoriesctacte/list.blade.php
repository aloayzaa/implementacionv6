...
@section('scripts')
    ...
    <script>
        $(function () {
            tableCategoriesCtaCte.init('{{ route('list.categoriesctacte') }}');
        });
        $('#listCategoriesCtaCte tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.categoriesctacte', ':id')}}';
