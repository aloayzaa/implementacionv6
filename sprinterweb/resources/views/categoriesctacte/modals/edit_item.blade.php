        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form_detalle" name="form_detalle" method="get">
                    ...
                    <input type="hidden" id="parent_id" name="parent_id" value="{{isset($pedido->id) ? $pedido->id : '0'}}">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <label for="modal_doc_asig_id">Codigo:</label>
                            <select class="select2 ag-modal-select referente-adit" id="modal_doc_asig_id" name="modal_doc_asig_id">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="update_item()" ><span class="fa fa-save"></span> Agregar Detalle</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
