...
@section('content')
    <div class="x_panel">
        <div class="x_content">
            <div class="col-xs-12">
                    <input type="hidden" id="ruta" name="ruta" value="{{ route('store.summaryballots') }}">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <form id="frm_generales" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        <button class="btn-info" onclick="getResumen('{{ route('getresumen.summaryballots') }}')">Resumen</button>
                                    </div>
                                </div>
                            ...
                            <div id="myTabContent" class="tab-content">
                                <div role="tabpanel" class="tab-pane fade active in" id="tab_detalles" aria-labelledby="home-tab">
                                    @include ('summaryballots.carrito')
                                </div>
                            </div>
                            @include ('summaryballots.modals.add_item')
                        </div>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script src="{{ asset('anikama/ani/summaryballots.js') }}"></script>
