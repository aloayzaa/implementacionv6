                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table id="deductionCatalog" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                <thead>
                                    <tr role="row">
...
@section('scripts')
    ...
    <script>
        $(function () {
            tableDeductionCatalog.init('{{ route('list.deductions') }}');
        });

        $('#deductionCatalog tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.deductions', ':id')}}';
