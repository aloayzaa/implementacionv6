...
@section('scripts')
    ...
    <script>
        $(function () {
            tableCashMovement.init('{{ route('list.cashmovement') }}');
        });

        $('#listCashMovement tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.cashmovement', ':id')}}';
