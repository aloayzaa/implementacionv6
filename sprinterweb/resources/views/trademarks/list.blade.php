                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table id="marksAndModels" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="datatable-responsive_info" style="width: 100%;">
                                <thead>
                                    <tr role="row">
...
@section('scripts')
    ...
    <script>
        $(function () {
            tableMarksAndModels.init('{{ route('list.trademarks') }}');
        });

        $('#marksAndModels tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.trademarks', ':id')}}';
