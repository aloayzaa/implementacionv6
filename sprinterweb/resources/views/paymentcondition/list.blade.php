...
@section('scripts')
    ...
    <script>
        $(function () {
            tablePaymentCondition.init('{{ route('list.paymentcondition') }}');
        });
        $('#listPaymentCondition tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.paymentcondition', ':id')}}';
