...
@section('scripts')
    ...
    <script>
        $(function () {
            tableTransactionTypes.init('{{ route('list.transactiontypes') }}');
        });
        $('#listTransactionTypes tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.transactiontypes', ':id')}}';
