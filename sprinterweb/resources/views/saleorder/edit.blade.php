        ...
        <div class="x_content">
            <div class="col-xs-12">
                <input type="hidden" id="ruta" name="ruta"
                       value="{{ route('update.saleorder', ['id' => $pedido->id]) }}">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <form id="frm_generales" autocomplete="off" class="identificador ocultar">
                                                    ...
                                                    <select class="form-control select2" name="txt_unegocio"
                                                        ...
                                                        @foreach($unidades as $unidad)
                                                            <option value="{{ $unidad->id }}"
                                                                    @if($unidad->id == $pedido->unegocio_id) selected @endif>
                                                ...
                                                <select class="form-control select2" name="txt_puntoventa"
                                                    ...
                                                    @foreach($puntosventa as $puntoventa)
                                                        <option value="{{ $puntoventa->id }}"
                                                                @if($puntoventa->id == $pedido->puntoventa_id) selected @endif>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control select2" name="txt_tipoventa"
                                                    ...
                                                    @foreach($tiposventa as $tipoventa)
                                                        <option value="{{ $tipoventa->id }}"
                                                                @if($tipoventa->id == $pedido->tipoventa_id) selected @endif>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control select2" name="txt_tercero"
                                                        id="txt_tercero">
                                                    <option value="{{$pedido->tercero_id}}"
                                                            selected>{{$pedido->tercero->codigo}}
                                                        | {{$pedido->tercero->descripcion}}</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control select2" name="txt_condicionpago"
                                                    ...
                                                    @foreach($condicionespago as $condicionpago)
                                                        <option value="{{ $condicionpago->id }}"
                                                                @if($condicionpago->id == $pedido->condicionpago_id) selected @endif>
                                        ...
                                        <div class="row">
                                                ...
                                                <select class="form-control select2" name="txt_tipodocumento"
                                                    ...
                                                    @foreach($tiposdocumento as $tipodocumento)
                                                        <option value="{{ $tipodocumento->id }}"
                                                                @if($tipodocumento->id == $pedido->documento_id) selected @endif>
                                                ...
                                                <select class="form-control select2" name="txt_vendedor"
                                                    ...
                                                    @foreach($vendedores as $vendedor)
                                                        <option value="{{ $vendedor->id }}"
                                                                @if($vendedor->id == $pedido->vendedor_id) selected @endif>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" class="form-control" name="txt_orden" id="txt_orden"
                                                       value="">
                                            </div>
                                        </div>
                                    </div>
