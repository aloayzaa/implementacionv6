...
@section('scripts')
    ...
    <script>
        $(function () {
            tableListBusinessUnits.init('{{ route('list.businessunits') }}');
        });

        $('#listBusinessUnits tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.businessunits', ':id')}}';
