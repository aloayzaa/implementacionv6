        ...
        <div class="x_panel">
            <div class="x_content">
                <div class="col-xs-12">
                    ...
                    <table id="listSeller" class="table display responsive nowrap table-striped table-hover table-bordered"
                           width="100%">
                        <thead>
                            <tr>
                                <th>Código</th>
...
@section('scripts')
    ...
    <script>
        $(function () {
            tableSeller.init('{{ route('list.seller') }}');
        });
        $('#listSeller tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.seller', ':id')}}';
