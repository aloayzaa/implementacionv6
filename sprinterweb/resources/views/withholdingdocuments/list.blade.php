        ...
        <div class="x_panel">
            <div class="x_title">
                <ul class="nav navbar-right panel_toolbox">
                    <a href="{{ route('create.withholdingdocuments') }}" data-toggle="tooltip" data-placement="left"
                ...
                <div id="datatable-responsive_wrapper"
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table id="listWithholdingDocuments"
...
@section('scripts')
    ...
    <script>
        $(function () {
            tableWithholdingDocuments.init('{{ route('list.withholdingdocuments') }}');
        });
    </script>
@endsection
