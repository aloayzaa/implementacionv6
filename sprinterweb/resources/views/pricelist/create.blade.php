    ...
    <div class="x_panel">
        <div class="x_content">
            <form class="form-horizontal" id="frm_generales" name="frm_generales" method="POST">
                <input type="hidden" id="ruta" name="ruta" value="{{ route('store.pricelist') }}">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 col-xs-12 label-input">
                                            <input class="form-control" type="text" name="txt_precio5" id="txt_precio5">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2 col-xs-12 label-input" style="width: 100px">
                                        ...
                                        <div class="col-md-2 col-xs-12 label-input">
                                            <input class="form-control" type="text" name="txt_precio2" id="txt_precio2">
                                        </div>
                                        <div class="col-md-2 col-xs-12 label-input" style="width: 100px">
                                            <label class="col-sm-12 col-xs-12" for="precio4">Precio 4: </label>
                                        </div>
                                        <div class="col-md-2 col-xs-12 label-input">
                                            <input class="form-control" type="text" name="txt_precio4" id="txt_precio4">
                                        </div>
                                        <div class="col-md-2 col-xs-12 label-input" style="width: 100px">
