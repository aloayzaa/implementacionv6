    <div class="modal fade" id="myModalUmedida" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
                ...
                <form action="" id="form_detalle" name="form_detalle">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12">
                            <label>UM:</label>
                            <select class="form-control select2" name="cbo_um" id="cbo_um">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" name="btn_modal_base" id="btn_modal_base" onclick="agregar_item()">
