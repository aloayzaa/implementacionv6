...
@section('scripts')
    ...
    <script>
        $(function () {
            tableListCostActivities.init('{{ route('list.costactivities') }}');
        });

        $('#listCostActivities tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.costactivities', ':id')}}';
