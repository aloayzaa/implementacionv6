                            ...
                            <table id="customerCatalog"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                        ...
                                        aria-label="Last name: activate to sort column ascending">Razón social
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
...
@section('scripts')
    ...
    <script>
        $(function () {
            tableCustomerCatalog.init('{{ route('list.customers') }}');
        });

        $('#customerCatalog tbody').on('dblclick', 'tr', function () {
            var url = '{{route('edit.customers', ':id')}}';
