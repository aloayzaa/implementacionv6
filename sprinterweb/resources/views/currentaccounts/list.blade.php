                    ...
                    <div class="panel-body">
                        <div class="col-md-12 col-xs-12">
                            <form name="frm_reporte" id="frm_reporte" method="GET">
                                ...
                                <input type="hidden" value="{{ route('list.currentaccounts') }}" id="ruta">
                                    ...
                                    <div class="col-md-2 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="balances" name="balances">
                                                <option value="PS">Saldos</option>
                                                <option value="PM">Movimienos</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2 col-xs-12">
                        ...
                        <div class="row">
                            <div class="contenido_scrollauto">
                                <table id="listCurrentAccounts" class="table table-striped table-bordered table-bordered2" width="100%">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="6" bgcolor="#01DFA5">Totales:</th>
...
@section('scripts')
    ...
    <script>
        $(function () {
            ...
            /*tableListCurrentAccounts('{{ route('list.currentaccounts') }}');*/
        });
    </script>
