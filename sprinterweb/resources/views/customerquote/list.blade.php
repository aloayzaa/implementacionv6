...
@section('scripts')
    ...
    <script>
        $(function () {
            tableCustormerQuote.init('{{ route('list.customerquote') }}');
        });
        {{--$('#ListCustomerQuote tbody').on('dblclick', 'tr', function () {--}}
        {{--    var url = '{{route('edit.customerquote', ':id')}}';--}}
