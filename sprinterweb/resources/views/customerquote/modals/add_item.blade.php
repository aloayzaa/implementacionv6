            ...
            <div class="modal-body">
                <form action="" id="form_detalle" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                            <label for="recipient-name" class="col-form-label">Precio Lista</label>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                            <label for="recipient-name" class="col-form-label">%Dsct</label>
                            <input type="number" class="form-control Desct" id="modal_dsct" placeholder="0.00" name="importe">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                            <label for="recipient-name" class="col-form-label">Precio Dscto</label>
                            <input type="number" class="form-control Desct" id="modal_Pdsct" placeholder="0.00" name="importe">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                            <label for="recipient-name" class="col-form-label">Sub Total</label>
                            <input type="number" class="form-control Desct" id="sub_total" placeholder="0.00" name="importe">
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <label for="" class="col-form-label">CodCliente:</label>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <label for="" class="col-form-label">Disponibilidad:</label>
