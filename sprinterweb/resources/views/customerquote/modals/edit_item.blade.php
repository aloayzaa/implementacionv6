    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
                ...
                <form action="" id="form_detalle" class="form-horizontal">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <select class="select2 ag-modal-select product" id="cbo_producto_edit" name="producto_id">
                                <option value=""></option>
                            </select>
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                            <label for="recipient-name" class="col-form-label">UM</label>
                            <input type="text" class="form-control um" id="txt_umedida" name="um" readonly>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 form-group">
                            ...
                            <input type="number" class="form-control importe" id="modal_importe" placeholder="0.00" name="importe" readonly>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <label for="" class="col-form-label">OP:</label>
                            <select class="select2 ag-modal-select" id="" name="">
                                <option value="">-Seleccione-</option>
                            </select>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <label for="" class="col-form-label">C. Costo / Descripción C. Costo:</label>
                            <select class="select2 ag-modal-select product" id="" name="centrocosto_id">
                                <option value="">-Seleccione-</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select class="select2 ag-modal-select product" id="" name="proyecto_id">
                                <option value="">-Seleccione-</option>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <select class="select2 ag-modal-select product" id="" name="actividad_id">
                                <option value="">-Seleccione-</option>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="update_item()"><span class="fa fa-save"></span>
                    Agregar Detalle
                </button>
            </div>
        </div><!-- /.modal-content -->
