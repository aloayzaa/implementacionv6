        ...
        <div class="x_content">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" id="frm_generales" name="frm_generales" data-route="{{ route('customerquote') }}">
                        <input type="hidden" id="_token" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" id="var" name="var" value="{{ $var }}">
                        <input type="hidden" id="proceso" name="proceso" value="{{ $proceso }}">
                        <input type="hidden" id="id" name="id" value="{{$ordencompra->id}}">
                        <input type="hidden" id="ruta" name="ruta" value="{{ route('update.customerquote') }}">
                        <input type="hidden" id="ruta_estado" name="ruta_estado" value="{{ route('estado.customerquote') }}">
                        <div class="row">
