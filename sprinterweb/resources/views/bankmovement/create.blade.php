    ...
    <div class="x_panel">
        <div class="x_content">
            <form class="form-horizontal" id="frm_generales" name="frm_generales" method="POST">
                ...
                <input type="hidden" id="ruta" name="ruta" value="{{ route('store.bankmovement') }}">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-xs-12">
                                <input type="checkbox" id="chkcheque" name="chkcheque"><label for="chkcheque"> Con
                                    Cheque:</label>
                                <input class="form-control" id="cheque" name="cheque" type="text"
                                       placeholder="Ingrese Cheque" readonly>
                            </div>
                            <div class="col-md-2 col-xs-12">
                                <input type="checkbox" id="chkdiffer" name="chkdiffer" disabled><label> Es
                                    Diferido:</label>
                                <input class="form-control" type="date" name="differ" id="differ" readonly>
                            </div>
                            <div class="col-md-3 col-xs-12">
                                <label for="girado">Girado a nombre de:</label>
                                <input class="form-control" id="girado" name="girado" type="text" readonly>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 col-xs-12">
