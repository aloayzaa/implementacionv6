...
{{--                    <a href="{{ route('create.categories') }}" data-toggle="tooltip" data-placement="left"--}}
                        ...
                        <div class="col-sm-12">
                            ...
                            <table id="listCategories"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive"
                                        rowspan="1" colspan="1" style="" aria-sort="ascending"
                                        aria-label="First name: activate to sort column descending">Cod.Sunat
                                    </th>
                                    <th class="sorting_asc" tabindex="0" aria-controls="datatable-responsive"
                                        rowspan="1" colspan="1" style="" aria-sort="ascending"
...
@section('scripts')
    ...
    <script>
        $(function () {
            tableCategories.init('{{ route('list.categories') }}');
        });
        $('#listCategories tbody').on('dblclick', 'tr', function () {
