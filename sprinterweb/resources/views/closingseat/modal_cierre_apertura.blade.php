<div class="modal fade" id="myModalCierreApertura" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-body">
                        ...
                        <div class="col-sm-12 col-xs-12" id="scrollable-dropdown-menu">
                            <select class="form-control" id="cost" name="cost">
                                ...
                                @foreach($costos as $costo)
                                    <option value="{{$costo->id}}">{{$costo->codigo}} | {{$costo->descripcion}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="col-sm-12 col-xs-12">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <label class="col-sm-12 col-xs-12">Glosa</label>
                            </div>
                        </div>
                        <div class="col-sm-12 col-xs-12" id="scrollable-dropdown-menu">
                            <input type="text" class="form-control" placeholder="Ingrese Glosa" id="glosam"
                                   name="glosam">
                        </div>
                    </div>
                </div>
