    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-md-10 col-sm-10 col-xs-12">
                ...
                <div class="row">
                    <table id="pedidos_de_ordencompra" class="table display responsive nowrap table-striped table-hover table-bordered"
                           width="100%" style="width:100%;margin: 0 auto;">
                        <thead>
                            <tr>
                                <th>Fecha</th>
                                <th>Referencia</th>
            ...
            <div class="col-md-2 col-sm-2 col-xs-12">
                <a onclick="archivar()" class="form-control btn-primary text-center"><span class="fa fa-folder-open-o"></span> Archivar</a>
                <br>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="row">
                    <label for="txt_total_in">Total Ingresos:</label>
                    <input type="text" id="txt_total_in" name="txt_total_in" readonly>
                    <input type="text" id="txt_total_ie" name="txt_total_ie" readonly>
                </div>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="row">
                ...
                <div class="row">
                    <label for="txt_total_pn">Total Ingresos:</label>
                    <input type="text" id="txt_total_pn" name="txt_total_pn" readonly>
                    <input type="text" id="txt_total_pe" name="txt_total_pe" readonly>
                </div>
            </div>
        </div>
    </div>
