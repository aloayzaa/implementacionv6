        ...
        <table id="cart_table" class="table table-striped table-bordered">
            ...
            @foreach($carts as $cart)
                ...
                <input type="hidden" name="txt_id_parent" id="txt_id_parent"
                       value="{{ $cart->options->has('parent_id') ? $cart->options->parent_id: ''}}">
                <tr class="">
                    <td data-title="Item">{{$i}}</td>
                    <td data-title="Código">{{ $cart->options->has('tercero_codigo') ? $cart->options->tercero_codigo: '' }}</td>
                    <td data-title="Nombre">{{ $cart->options->has('tercero_descripcion') ? $cart->options->tercero_descripcion: '' }}</td>
                    <td data-title="Referencia">{{ $cart->options->has('referencia') ? $cart->options->referencia: '' }}</td>
