        ...
        <div class="x_panel">
            ...
            <div class="x_title">
                <ul class="nav navbar-right panel_toolbox">
                    <a href="{{ route('create.transfers') }}" data-toggle="tooltip" data-placement="left"
                            ...
                            <table id="listTransfers"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                        ...
                                        aria-label="Last name: activate to sort column ascending">Númer
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                        rowspan="1" colspan="1" style="width: 30%;"
                                        aria-label="Age: activate to sort column ascending">De
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                        rowspan="1" colspan="1" style="width: 20%;"
                                        aria-label="Age: activate to sort column ascending">A
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                        rowspan="1" colspan="1" style="width: 20%;"
                                        aria-label="Age: activate to sort column ascending">Mon
...
@section('scripts')
    ...
    <script>
        $(function () {
            tableTransfers.init('{{ route('list.transfers') }}');
        });
        $('#listTransfers tbody').on('dblclick', 'tr', function () {
