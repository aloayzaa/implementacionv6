...
class OpeningReceivableCollection
{
            ...
            $opening->actions =
                '<div class="btn-group">
                            ...
                            <li class="list-dropdown-actions">
                                 <a href="' . route( 'show.openingReceivable', ['id' => $opening->id]) . '">Ver <span class="fa fa-eye text-success"></span></a>
                            </li>
                            <li class="list-dropdown-actions">
                                 <a href="' . route( 'edit.openingReceivable', ['id' => $opening->id]) . '">Actualizar <span class="fa fa-pencil text-primary"></span></a>
                            </li>';
            if ($opening->estado == 1) {
