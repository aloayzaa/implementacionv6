...
class OpeningToPayController extends Controller
{
    private $var = 'openingToPay';
    ...
    public function index(Request $request)
    {
        ...
        $data['view'] = link_view('Compras', 'Transacción', 'Apertura Por Pagar', '');
        $data['header'] = headeroptions($this->var, 'list', '', '');
        return view('openingsPay.list', $data);
    }

    public function list()
    {
        $openings = DocumentToPay::lista_apertura();
    ...
    public function create()
    {
        ...
        return view('openingsPay.create', $data);
    }
...
//            $opening->docplanilla_id = 1;
    ...
    public function show($id)
    {
        ...
        return view('openingsPay.edit', $data);
    }
