...
class CurrentAccountsController extends Controller
{
    ...
    protected $privilegios = '04.04.01';
    protected $user;
    ...
    public function index()
    {
        ...
        $data['var'] = $this->var;
        $data['process'] = 'compra';
        $data['view'] = link_view('Compras', 'Reportes', 'Cuenta Corriente Proveedor', '');
        ...
        return view('currentaccounts.list', $data);
    }
    ...
    public function list(ReportsRequest $request)
    {
        ...
        if ($request->provider != null) {
            ...
            $resultadop = ProcedureReports::rptCtaCtexPagar($id_proveedor, $id_tipo_reporte, $fecha);
