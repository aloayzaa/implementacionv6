...
class LedgerController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $resultado = $this->procedurereports->rptLibroMayor($fecha_inicial, $fecha_final, $tipo);
    ...
    public function index(Request $request)
    {
        ...
        $data['view'] = link_view('Contabilidad', 'Reportes', 'Libro Mayor', '');
        $data['header'] = headeroptions($this->var, 'list','','');

        return view('ledger.list', $data);
    }
    ...
    public function libro_mayor(Request $request)
    {
        ...
        $resultado = $this->procedurereports->rptLibroMayor($fecha_inicio, $fecha_fin, $tipo);
        $resultados = collect($resultado);

        $codigo_periodo = $this->obtener_cod_periodo($fecha_inicio, $fecha_fin);
        $nombre = "LE" . Session::get('company_ruc') . $codigo_periodo . "00060100001111.txt";
        $csv_end = "\r\n";
        $csv_sep = "|";
