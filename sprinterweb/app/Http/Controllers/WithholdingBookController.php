...
class WithholdingBookController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['view'] = link_view('Gestión Tributaria', 'Reportes', 'Libro de Retenciones Renta 4ta', '');
        $data['period'] = Period::findOrFail(Session::get('period_id'));
        $data['currencies'] = Currency::all();

        return view('withholdingbook.list', $data);
    }
    ...
    public function list(Request $request)
    {
        ...
        $resultado = $this->procedurereports->rptComprasRetencion($fecha_inicio, $fecha_fin, $tipo);
